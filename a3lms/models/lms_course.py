...
class LmsCourse(models.Model):
	...
	grade_grouping = fields.Selection(string='Grade Grouping By', selection=[('module', 'Module'), ('technique', 'Technique'),], default='module', required=True)
	grade_weighting = fields.Selection(string='Grade Weighting', selection=[('points', 'Points'), ('percentage', 'Percentage'),])	
