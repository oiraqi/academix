...
class Event(models.Model):
    _name = 'ixcalendar.term'
    _description = 'Important Date'
    _inherit = 'ix.activity'
    _sql_constraints = [('ixcalendar_idate_ukey', 'unique(year, semester, type)', 'IDate already exists!')]
    ...
    standard_event_id = fields.Many2one(comodel_name='ixcalendar.standard.event', string='Standard Event')
