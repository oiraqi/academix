...
class Action(models.Model):
	...
	portfolio_id = fields.Many2one(comodel_name='ixqms.portfolio', string='Portfolio')
	assessment_line_id = fields.Many2one(comodel_name='ixqms.assessment.line', string='Assessment Line')
