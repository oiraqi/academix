...
class LmsAssessmentLine(models.Model):
    ...
    assessed_ilo_ids = fields.One2many(comodel_name='ixqms.assessed.ilo', inverse_name='assessment_line_id', string='Assessed ILOs')
    ...
    def create_assessed_ilos(self):
        ...
        for ilo in self.assessment_id.ilo_ids:
            if ilo.id not in assessed_ilo_ids:
                self.env['ixqms.assessed.ilo'].create({            
