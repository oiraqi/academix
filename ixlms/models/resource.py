...
class Resource(models.Model):
	...
	type = fields.Selection(string='Type', selection=[('book', 'Book'), ('case_study', 'Case Study'), ('code', 'Code'), ('data', 'Data'), ('notes', 'Notes'), ('paper', 'Paper'), ('report', 'Report'), ('slides', 'Slides'), ('standard', 'Standard'), ('video', 'Video'), ('wpage', 'Web Page'), ('wpaper', 'White Paper')])
