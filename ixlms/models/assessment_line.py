...
class AssessmentLine(models.Model):
	...
	grade_grouping = fields.Selection(related='assessment_id.lms_course_id.grade_grouping', store=True)
	grade_weighting = fields.Selection(related='assessment_id.lms_course_id.grade_weighting', store=True)
